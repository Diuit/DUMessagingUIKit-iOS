...
public protocol DUMessageCollectionViewFlowLayoutDelegate: UICollectionViewDelegateFlowLayout {
     ...
     */
    func heightForCellTopLabel(atIndexPath indexPath: NSIndexPath, withLayout layout: DUMessageCollectionViewFlowLayout, inCollectionView collectionView: DUMessageCollectionView) -> CGFloat
    /**
        ...
        - returns: A CGFlot value to specify the height of the label. Return `0.0` if you don't watn to display it.
     */
    func heightForMessageBubbleTopLabel(atIndexPath indexPath: NSIndexPath, withLayout layout: DUMessageCollectionViewFlowLayout, inCollectionView collectionView: DUMessageCollectionView) -> CGFloat
